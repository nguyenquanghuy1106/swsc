...
def _render_topbar():
    topbar_html = (
        ...
        '<div class="medical-topbar-icon-wrap"><div class="medical-topbar-badge">5</div><div class="medical-topbar-icon">🔔</div></div>'
        '<div class="medical-topbar-icon-wrap"><div class="medical-topbar-badge">1</div><div class="medical-topbar-icon">📩</div></div>'
...
def _render_search():
    st.markdown(
        ...
        '<span class="medical-banner-search-text">Tìm dụng cụ y tế, chất liệu, thời gian phân hủy...</span>'
        '</div>',
...
def _render_card(item: dict):
    ...
    card_html = (
        ...
        f'<div class="medical-progress-fill" style="width:{bar_width}; background:{bar_color};"></div>'
        f'</div>'
...
def _render_actions():
    actions_html = (
        ...
        '</div>'
        '<div class="medical-action-card">'
        f'<a href="{_page_url("ai")}" class="medical-action-btn blue medical-ai-link">🤖 Nhận diện rác bằng AI</a>'
        '</div>'
        '</div>'
    )
